...
def parse_opt(known=False):
    ...
    parser.add_argument('--cfg', type=str, default='./models/transformer/yolov5l_fusion_transformerx3_resnetcsp_dronevehicle_aligned.yaml', help='model.yaml path')   # DarkNet
    #parser.add_argument('--cfg', type=str, default='./models/transformer/yolov5l_fusion_transformerx3_new_dronevehicle_aligned.yaml', help='model.yaml path')  # ResNet
