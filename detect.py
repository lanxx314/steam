...
def parse_opt():
    ...
    parser.add_argument('--weights', nargs='+', type=str, default=ROOT / 'runs/train/exp476/weights/best.pt', help='model path(s)')
    parser.add_argument('--source1', type=str, default='./DroneVehicle/rgb/test/images/', help='file/dir/URL/glob, 0 for webcam')
    parser.add_argument('--source2', type=str, default='./DroneVehicle/ir/test/images/',help='file/dir/URL/glob, 0 for webcam')
